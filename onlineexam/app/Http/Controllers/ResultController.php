...
class ResultController extends Controller
{
    ...
    public function index()
    {
        ...
        $DataPoints = array(
           array("y"=> 5, "name"=> "Right", "color"=> "#E7823A"),
           array("y"=> 5, "name"=> "wrong", "color"=> "#546BC1")
);
          
                return view('result.chart')->with('total',$total)->with('score',$score)->with('wrong_ans',$wrong_ans)->with('DataPoints',$DataPoints);
