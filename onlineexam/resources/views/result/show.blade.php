...
<div>
    ...
    <div class="text-center" > <a href="{{ url('result') }}" class="btn btn-primary btn-block">Result in chart</a></div>
    <br>
    <div class="text-center" > <a href="{{ url('home') }}" class="btn btn-primary btn-block">Back</a></div>
@endsection